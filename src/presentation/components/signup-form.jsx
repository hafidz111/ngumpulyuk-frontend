...
export function SignupForm({ className, passwordError, onSubmit, ...props }) {
      ...
      <Card className='border-0 bg-card shadow-[0_8px_40px_-4px_hsl(var(--foreground)/0.08)] rounded-[1.75rem]'>
        ...
        >
          ...
          <Button
            type='button'
            variant='outline'
            className='h-12 w-full rounded-full border-border bg-background font-medium text-foreground shadow-none hover:bg-muted/60'
          >
            <GoogleMark />
            Google
          </Button>
